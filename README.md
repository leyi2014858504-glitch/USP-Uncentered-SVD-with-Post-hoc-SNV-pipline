...
Data preprocessing:
- 71 samples → filter unknown/outlier → ~57 usable (depends on CSV intersection)
- Dominant fiber label
...
| [OpenTextile-NIR: Near-infrared hyperspectral imaging and photography dataset for optical identification of textiles](https://zenodo.org/records/18269172) | `swir_mean_spectra.csv`, `ground_truth_final.csv` | `1/swir_mean_spectra.csv`, `1/ground_truth_final.csv` |
